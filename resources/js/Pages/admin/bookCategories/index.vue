...
const deleteHandle = async () => {
    axios
        .delete(route("categories.delete", { id: itemSelected.value.id }))
        .then((res) => {
            notify(
                {
                    type: "success",
    ...
    >
        ...
        <VDataTable :heads="heads" :isLoading="isLoading">
            ...
            <tr v-for="(data, index) in query" :key="index" v-else>
                <td width="5%" class="p-4 whitespace-nowrap h-16">
                    {{ index + 1 }}
                </td>
